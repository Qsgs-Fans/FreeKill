...
Fk:loadTranslationTable {
  ...
  ["Pause Download"] = "暂停下载",
  ["Start Download"] = "开始下载",
  ["Total skins %1, %2 skins waiting for downloading"] = "共加入%1张皮肤，其中%2张未下载",
  ["Downloading: "] = "下载：",
  ["Start Downloading Skins"] = "开始下载皮肤......",
  ["All skins downloaded: success: %1; fail: %2; total: %3"] = "所有皮肤下载完毕：成功：%1；失败：%2；总共：%3",
  ["Download Success"] = "下载成功",
  ["Download Fail"] = "下载失败",
  ["Skins Count: "] = "皮肤统计：",
  ["Download Threads: "] = "下载线程数：",
  ["Skin Downloading Paused"] = "<font color='blue'>---已暂停下载---",
  ["Continue Skin Downloading"] = "<font color='yellow'>---继续下载---",
  ...
  ["Spectate"] = "旁观",
  ["Take Seat"] = "入座",
  ["Waiting for game to start"] = "等待对局开始",
  ["Game Rule"] = "游戏规则",
  ["Game Mode"] = "游戏模式",
  ["Enable free assign"] = "自由选将",
  ["help: Enable free assign"] = "启用后在选将界面长按或右键武将牌。",
  ["#Enable free assign"] = "<font color='red'>自由选将</font>",
  ["Enable deputy general"] = "启用副将机制",
  ["help: Enable deputy general"] = "请注意部分模式本身不支持副将机制。",
  ["#Enable deputy general"] = "<font color='red'>启用副将机制</font>",
  ["Disable same convert"] = "关闭同名武将替换",
  ["help: Disable same convert"] = "关闭后，同名武将视为不同武将牌，可同时出现。",
  ["#Disable same convert"] = "<font color='red'>同名武将替换已关闭</font>",
  ["Observer can view card"] = "旁观者可见手牌",
  ["help: Observer can view card"] = "开启后，旁观者将可以看到其视角下的牌，包括切换视角后",
  ["#Observer can view card"] = "旁观者可以看见手牌",
...
Fk:loadTranslationTable {
  ...
  ["#ChangeGender"] = "%from 的性别从 %arg 变成了 %arg2",
  ["#ChangeKingdom"] = "%from 的势力从 %arg 变成了 %arg2",
  ["#ChangeRole"] = "%from 的身份从 %arg 变成了 %arg2",
