...
function TrustAI:assignValue(assign)
...
function TrustAI:getValue(card, kept)
...
function TrustAI:getPriority(card)
...
function TrustAI:sort(players, key, inverse)
  key = key or "defense"
...
function TrustAI:sortValue(cards, inverse)
  local function compare_func(a, b)
...
function TrustAI:sortPriority(cards, inverse)
  local function compare_func(a, b)
...
function TrustAI:getRetrialCardId(cards, exchange)
...
function TrustAI:getActives(pattern)
  local cards =
      table.map(
        self.player:getCardIds("&he"),
        function(id)
...
function TrustAI:setUseId(pattern)
  local cards =
      table.map(
        self.player:getCardIds("&he"),
        function(id)
...
function TrustAI:cardsView(pattern)
  local actives =
      table.filter(
        self.player:getAllSkills(),
        function(s)
