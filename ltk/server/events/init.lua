...
local tmp
tmp = require "ltk.server.events.misc"
GameEvent.ChangeProperty = tmp[1]
table.assign(GameEventWrappers, tmp[2])

tmp = require "ltk.server.events.hp"
