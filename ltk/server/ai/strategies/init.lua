local active = require 'ltk.server.ai.strategies.active'
local card_skill = require 'ltk.server.ai.strategies.card_skill'
local discard = require 'ltk.server.ai.strategies.discard'
local choose_player = require 'ltk.server.ai.strategies.choose_player'
local cards = require 'ltk.server.ai.strategies.cards'
local view_cards = require 'ltk.server.ai.strategies.view_cards'
local view_cards_and_choice = require 'ltk.server.ai.strategies.view_cards_and_choice'
local choose_cards_and_choice = require 'ltk.server.ai.strategies.choose_cards_and_choice'
local choose_cards_and_players = require 'ltk.server.ai.strategies.choose_cards_and_players'
local yiji = require 'ltk.server.ai.strategies.yiji'
local choose_general = require 'ltk.server.ai.strategies.choose_general'
local choose_kingdom = require 'ltk.server.ai.strategies.choose_kingdom'
local choose_card = require 'ltk.server.ai.strategies.choose_card'
local poxi = require 'ltk.server.ai.strategies.poxi'
local choose_cards = require 'ltk.server.ai.strategies.choose_cards'
local choice = require 'ltk.server.ai.strategies.choice'
local choices = require 'ltk.server.ai.strategies.choices'
local joint_choice = require 'ltk.server.ai.strategies.joint_choice'
local joint_cards = require 'ltk.server.ai.strategies.joint_cards'
local invoke = require 'ltk.server.ai.strategies.invoke'
local arrange_cards = require 'ltk.server.ai.strategies.arrange_cards'
local exchange = require 'ltk.server.ai.strategies.exchange'
local number = require 'ltk.server.ai.strategies.number'
local ag = require 'ltk.server.ai.strategies.ag'
