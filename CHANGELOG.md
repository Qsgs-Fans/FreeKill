...
- 为旁观者建立独立的身份，返回房间不再依赖顶替被旁观者的身份

### Bug修复

- 修复被旁观者退房后旁观者返回房间可能崩溃的问题
- 修复被旁观者的游戏时长被错误显示成旁观者时长的问题
- 修复旁观多个房间时页面栈堆积多个大厅页面的问题
- 修复旁观视角下 moveCards visiblePlayers 触发报错的问题
...
- 为服务端提供了新的旁观功能，允许玩家在WaitingRoom旁观与切换旁观和在座，并允许旁观玩家在对局结束后自动返回房间
- 允许客户端下载远程资源到本体assets目录下，并可以令qml调度这些资产
- 为开发者提供了一种快速启动预定对局的方式

### Bug修复

- *(windows)* 修复可能出现的音频中断或丢失问题
